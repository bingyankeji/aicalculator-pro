...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: 'website',
    url: 'https://aicalculator.com/graphing-calculator',
  ...
  alternates: {
    canonical: 'https://aicalculator.com/graphing-calculator',
  },
  robots: {
    index: true,
    follow: true,
...
const structuredData = {
  ...
  '@graph': [
    {
      '@type': 'WebApplication',
      '@id': 'https://aicalculator.com/graphing-calculator#webapp',
    ...
    {
      '@type': 'BreadcrumbList',
      '@id': 'https://aicalculator.com/graphing-calculator#breadcrumb',
      itemListElement: [
        {
          '@type': 'ListItem',
          position: 1,
        ...
        },
        {
          ...
          position: 2,
          name: 'Math & Numbers',
          item: 'https://aicalculator.com/math-calculators',
        },
        {
          '@type': 'ListItem',
          position: 3,
          name: 'Graphing Calculator',
          item: 'https://aicalculator.com/graphing-calculator',
        },
      ],
    },
    {
      '@type': 'FAQPage',
      '@id': 'https://aicalculator.com/graphing-calculator#faq',
      mainEntity: [
        {
          '@type': 'Question',
    ...
    {
      '@type': 'HowTo',
      '@id': 'https://aicalculator.com/graphing-calculator#howto',
      ...
      <nav className="bg-white border-b border-gray-200" aria-label="Breadcrumb">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center space-x-4 py-4">
            ...
            <Link href="/math-calculators" className="text-gray-500 hover:text-gray-700 transition-colors">
              Math & Numbers
            </Link>
            <span className="text-gray-400">/</span>
            <span className="text-gray-900 font-medium">Graphing Calculator</span>
          </div>
        </div>
      </nav>
