    ...
    <div className="w-full max-w-6xl mx-auto space-y-8">
      ...
      <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
        ...
        <div className="grid md:grid-cols-3 gap-4 mb-6">
          ...
          >
            <Timer className={`w-6 h-6 mx-auto mb-2 ${mode === 'pace' ? 'text-blue-600' : 'text-gray-400'}`} />
            <div className="font-semibold">Calculate Pace</div>
          ...
          >
            <Target className={`w-6 h-6 mx-auto mb-2 ${mode === 'time' ? 'text-green-600' : 'text-gray-400'}`} />
            <div className="font-semibold">Calculate Time</div>
          ...
          >
            <TrendingUp className={`w-6 h-6 mx-auto mb-2 ${mode === 'distance' ? 'text-purple-600' : 'text-gray-400'}`} />
            <div className="font-semibold">Calculate Distance</div>
