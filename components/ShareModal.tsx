...
export function ShareModal({ isOpen, onClose, shareUrl, shareText, calculatorName }: ShareModalProps) {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-6 relative">
        ...
        <p className="text-gray-600 mb-4 text-sm">
          Share your calculation with friends and family. They'll see your inputs and can calculate their own results.
        </p>
        ...
        <div className="mt-6 p-4 bg-blue-50 rounded-lg">
          <p className="text-xs text-gray-600">
            <strong className="text-blue-600">💡 Tip:</strong> The link will auto-fill your friend's calculator with your data. They can then adjust and calculate their own results.
          </p>
        </div>
      </div>
    </div>
